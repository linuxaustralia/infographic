...
const annularWidth    = 120;      // width of each annular (outer radius of donut)
const annularSpacing  = 120;      // inner radius of donut
...
const linePercentage    = 0.83;    // a value between 0 and 1 representing what percentage of the radius the label line is.
